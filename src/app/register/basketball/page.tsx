...
export default function BasketballRegistrationPage() {
    ...
    async function onSubmit(data: FormData) {
        ...
        try {
            const result = await registerBasketballTeam(dummyState, data);
    ...
    const upiUrl = `upi://pay?pa=${upiId}&pn=${upiName}&am=${fee}&cu=INR&tn=ElevateBasketballRegistration`;
